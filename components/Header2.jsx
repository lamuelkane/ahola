    ...
    return (
        ...
        <div className={`flex align-center ${styles.homeheader}`}>
            ...
            <div className={`${styles.headersmall} bg-gray-700  ${show ? 'showsidebar' : 'sidebar'}`}>
                <span className={`${styles.homenaveitems}`}><Link href='/tutors'>
                                  {  router.locale  === 'en-US' ? 'Find a Tutor'
                  ...
                  <span className={`${styles.homenaveitems}`}><Link href='/tutor_register'>
                ...
                <span className={`${styles.homenaveitems}`}><Link href='/login'>
                          {  router.locale  === 'en-US' ? 'login'
