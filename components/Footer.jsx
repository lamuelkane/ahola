  ...
  const router = useRouter()
    ...
    return (
        ...
        <div className={`center ${styles.contactus}`}>
                <h1 className={`text-white  text-2xl  margin-bottom`}>Learn Languages</h1>
                { 
            ...
            <div className={`center ${styles.contactus}`}>
                <h1 className={`text-white  text-2xl  margin-bottom`}>Learn Skills</h1>
                { 
            ...
            <div className={`center ${styles.contactus}`} style={{textAlign: 'start'}}>
                <h1 className={`text-white  text-2xl margin-bottom`}>Contact Us</h1>
                <h3>Need any help?</h3>
                <div>
