                ...
                <div className={`flex align-center justify-between ${styles.homeheader}`}>
                    <div className={`flex align-center `}>
                        ...
                        <div className={`${styles.headerlarge} text-gray-500`}>
                            <span className={`${styles.homenaveitem} p-2 hover:bg-gray-700 hover:text-white text-sm`}><Link href='/dashboard'>Dashboard</Link></span>
                            ...
                            <span className={`${styles.homenaveitem} hover:bg-gray-700 hover:text-white p-2 px-4`}><Link href='/payments'>Payments</Link></span>
