...
export default function RegisteredTutor({tutor, hide}) {
    const {sever, sever3} = useSelector((state) => state);
             ...
             try {
               ...
               { 
                 tutor : {country,
                   ...
                   template: tutoraccountsuccess(firstname, 'https://ahola.ch/login')
               }
               )
...
<dl>
  ...
  <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
    ...
    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"> {tutor?.freetrial} </dd>
  </div>
  <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
  ...
  <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
    ...
    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
      ...
      >
          <a href={tutor?.image} rel='noreferrer' target='_blank'><img src={tutor.image} width='100px' height='100px' alt="" /></a>
      </label>
    </dd>
  </div>
  <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
    ...
    <div className="grid grid-cols-3 gap-6">
          ...
          <div>
            <div className={`${styles.videopreview}`}>
                  {
                    tutor?.video?.includes(sever3) ? <video src={tutor?.video} controls ></video> 
                    :
