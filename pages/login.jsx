          ...
          <form className="mt-8 space-y-6" action="#" method="POST"   onSubmit={async(e) => {
                ...
                const info ={
                 ...
                 try {
                  ...
                  Notification({
                    title:"ERROR",
                    message:`An error occured, please try again. if you are a student, please check your credentials`,
                    type:"danger",
                    container:"top-right",
                    insert:"top",
                    animationIn:"fadeInUp",
...
export async function getStaticProps({locale}) {
  const pagecontent = {
    ...
    : locale === 'zh' ?
                              '电子邮件地址'
    :  'Email address',
    signuptutor: locale  === 'en-US' ? 'register as a tutor'

    : locale === 'fr' ? `s'inscrire comme tuteur`
    
    : locale === 'de' ?
                              'als Nachhilfelehrer anmelden'
    : locale === 'es' ?
    ...
    : locale === 'zh' ?
                              `或者`
    :  'Or',
    studentsignup: locale  === 'en-US' ? 'register as a student '

    : locale === 'fr' ? `s'inscrire en tant qu'étudiant`
